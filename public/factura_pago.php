...
// Verificar si el usuario está logueado y si llega el ID de pago
...
// Generar número de factura (ej: F-00001)
...
// Agregar filas por cada paquete comprado
...
$html .= '
    ...
    <h3 style="text-align:right; margin-top:20px;">Total Pagado: $' . number_format($pago['monto_total'], 0, ',', '.') . '</h3>
...
// Descargar el PDF
$nombre_usuario = preg_replace('/[^A-Za-z0-9]/', '', $_SESSION['usuario']['nombre']); // Limpiar nombre para el archivo
