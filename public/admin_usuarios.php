                ...
                <nav aria-label="Paginación">
                    <ul class="pagination justify-content-center mt-4">
                        <?php if ($pagina_actual > 1) { ?>
                            <li class="page-item">
                                <a class="page-link"
                                    href="admin_usuarios.php?pagina=<?php echo $pagina_actual - 1; ?>">Anterior</a>
                            </li>
                        <?php } ?>

                        <?php for ($i = 1; $i <= $total_paginas; $i++) { ?>
                            <li class="page-item <?php echo ($i == $pagina_actual) ? 'active' : ''; ?>">
                                <a class="page-link" href="admin_usuarios.php?pagina=<?php echo $i; ?>"><?php echo $i; ?></a>
                            </li>
                        <?php } ?>
                        ...
                        <?php if ($pagina_actual < $total_paginas) { ?>
                            <li class="page-item">
                                <a class="page-link"
                                    href="admin_usuarios.php?pagina=<?php echo $pagina_actual + 1; ?>">Siguiente</a>
                            </li>
                        <?php } ?>
                    </ul>
                </nav>
